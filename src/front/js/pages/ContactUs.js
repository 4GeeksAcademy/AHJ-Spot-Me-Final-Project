        ...
        <div className="contact-us">
            ...
            <div className="developer-cards-container">
                <div className="developer-card">
                    ...
                    <div className="links">
                        <a href="https://github.com/Adrianpina11" target="_blank" rel="noopener noreferrer" className="github-link">
                ...
                <div className="developer-card">
                    ...
                    <div className="links">
                        <a href="https://github.com/baguajoe" target="_blank" rel="noopener noreferrer" className="github-link">
                            <i className="fab fa-github"></i> GitHub
                        </a>
                ...
                <div className="developer-card">
                    ...
                    <div className="links">
                        <a href="https://github.com/hnkgarcia" target="_blank" rel="noopener noreferrer" className="github-link">
                            <i className="fab fa-github"></i> GitHub
                        </a>
